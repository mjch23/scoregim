...
@foreach($gimnastas as $gimnasta)		
						...
						<form method="POST" action="{{ route('barras.update',$gimnasta->id, $gimnasta->puntos) }}"  role="form">
							{{ csrf_field() }}
						...
						<div class="col-xs-6 col-sm-6 col-md-6">
							<div class="form-group">
								<input type="number" step="0.01" min="0" name="puntos" id="puntos" class="form-control input-sm" onChange="validarSiNumero(this.value);" value="{{$gimnasta->puntos}}">
							</div>
						</div>
