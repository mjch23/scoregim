  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        ...
        <img src="{{url('/images/barras.png')}}" class="rounded float-right" width="100" height="100">
            ...
            <table id="mytable" class="table table-bordred table-striped">
             ...
             <tbody>
              ...
              <tr>
                ...
                <td>
                @if($gimnastas->puntos!=null)
                <a class="btn btn-primary btn-xs" href="{{action('BarrasController@edit', $gimnastas->id)}}" target="_blank" onClick="window.open(this.href, this.target,'width=300,height=600'); return false;"><span class="fas fa-user-edit"></span></a>
                @else
                @endif
                </td>
