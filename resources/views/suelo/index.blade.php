  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        ...
        <img src="{{url('/images/suelo.png')}}" class="rounded float-right" width="100" height="100">

        <h1 class="card-title">Listado Suelo</h1>

        {{ Form::open(['route' => 'suelo', 'method' => 'GET', 'class' => 'form-inline pull-right'])}}
...
<div class="row">
  <div class="col-sm-12">
    <div class="card">
                ...
                <div class="invisible">
			    <input type="text" name="id_aparato" id="id_aparato" class="input-sm" value="2"> </div>
            ...
            <table id="mytable" class="table table-bordred table-striped">
             ...
             <tbody>
              ...
              <tr>
                ...
                <td>
                @if($gimnastas->puntos!=null)
                <a class="btn btn-primary btn-xs" href="{{action('SueloController@edit', $gimnastas->id)}}" target="_blank" onClick="window.open(this.href, this.target,'width=300,height=600'); return false;"><span class="fas fa-user-edit"></span></a>
                @else
                @endif
                </td>
